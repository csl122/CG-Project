...
bool SoldierShooting::_flagLose = false;

SoldierShooting::SoldierShooting(MyScene* scene, Vertex* color, int winding) : WorldObject(scene, 0, "test", 0),
...
void SoldierShooting::SetLose(bool flag)
{
	_flagLose = flag;
}


void SoldierShooting::Display() {
...
void SoldierShooting::RenderFace(Face* face) {
...
void SoldierShooting::RenderVertex(int vertexIndex) {
...
void SoldierShooting::setScale(Vertex* size) {
	this->vSize = size;
	scale[0] = vSize->x;
	scale[1] = vSize->y;
	scale[2] = vSize->z;
...
void SoldierShooting::setOrientation(Vertex* orientation) {
...
void SoldierShooting::HandleKey(unsigned char key, int state, int x, int y)
{
	
}

void SoldierShooting::HandleSpecialKey(int key, int state, int x, int y)
{
